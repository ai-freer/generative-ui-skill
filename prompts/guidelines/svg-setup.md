...
**Font size calibration for diagram text labels** - Here's csv table to give you better sense of the var(--font-sans), system-ui, -apple-system, sans-serif font rendering width:
```csv
